...
const copy = {
  zh: {
    ...
    transitEyebrow: '区域之间 · 固定中转站', transitTitle: '先回到渡口潮图台', transitBody: '你离开{from}，沿铜钉水线回到所有区域共用的潮图台。你在这里重新确认潮位和去向，再转往{to}；城市没有在两个画面之间突然跳切。', transitContinue: '确认潮位，前往下一站',
    entryEyebrow: '一个会被后来者改变的异步世界', coverAlt: '潮痕之城：灯塔与潮水中的城市', enterCity: '走进潮痕之城', enterLoading: '正在听城市醒来…',
    resumeTitle: '欢迎回到潮痕之城', resumeDescription: '你的个人进入记录已经恢复。可以直接回到最新潮痕，也可以从世界背景重新开始阅读。', resumeContinue: '继续游戏', resumeRestart: '重新开始', resumeRestartWarning: '这只会从世界背景重新阅读；公共世界、其他玩家的潮痕和你的个人行囊都会保留。', resumeRestartConfirm: '从开头进入', resumeRestartCancel: '返回选择',
  ...
  en: {
    ...
    transitEyebrow: 'BETWEEN DISTRICTS · RECURRING WAYSTATION', transitTitle: 'Return to the ferry tide table first', transitBody: 'You leave {from} and follow the copper waterline back to the tide table shared by every district. Here you confirm the tide and your route before continuing to {to}; the city never cuts directly between two unrelated views.', transitContinue: 'Confirm the tide and continue',
    ...
    resumeTitle: 'Welcome back to the City of Tides', resumeDescription: 'Your personal visit record is ready. Continue at the latest tide trace, or begin again from the world background.', resumeContinue: 'Continue game', resumeRestart: 'Start over', resumeRestartWarning: 'This only restarts your reading from the world background. The shared world, other players’ traces, and your personal pack remain intact.', resumeRestartConfirm: 'Enter from the beginning', resumeRestartCancel: 'Back to choices',
